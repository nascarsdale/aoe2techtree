...
print('This script will ask you for units & techs that you would like a civ to have. You can enter as many as you like. Please refer to the readme for information about how the techs are described (e.g. instead of \"ring archer armor\", the entry in this script is \"archer armor 3\"')
